...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center">
        ...
        <asp:DropDownList class="btn btn-outline-primary" ID="ddlVaccBatch" runat="server" Visible="false"></asp:DropDownList>
    </div>

    <br /><br /><br />
    <div class="text-center">
        <asp:GridView class="container" ID="GridViewMatchResult" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
