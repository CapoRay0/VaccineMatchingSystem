...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        <asp:Button class="btn btn-outline-primary" ID="Button1" runat="server" Text="讀取本批次使用者資料" OnClick="Button1_Click" />&nbsp &nbsp &nbsp
        <asp:Button class="btn btn-outline-success" ID="Button2" runat="server" Text="讀取本批次疫苗資料" OnClick="Button1_Click" />
    </div>
    <br />
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        <asp:Button class="btn btn-outline-primary" ID="btnInsetUserInfo" runat="server" Text="匯入使用者資料" OnClick="btnInsetUserInfo_Click" />&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <asp:Button class="btn btn-outline-success" ID="btnInsertVaccQuin" runat="server" Text="匯入本批疫苗資料" OnClick="btnInsertVaccQuin_Click" />
    </div>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        <asp:Button class="btn btn-outline-success" ID="Button3" runat="server" Text="讀取匯入的本批次疫苗資料" Width="50%" OnClick="Button3_Click" />
    </div>
    <br />
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        <asp:Button class="btn btn-outline-dark btn-lg" ID="btnStartMatching" runat="server" Text="檢視配對" OnClick="btnStartMatching_Click" /> &nbsp &nbsp &nbsp
        <asp:Button class="btn btn-outline-info btn-lg" ID="btnToFeedback" runat="server" Text="前往回饋頁" OnClick="btnToFeedback_Click" /> &nbsp &nbsp &nbsp
